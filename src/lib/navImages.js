...
export const STAT_IMAGES = {
  'Objectif':             `${BASE_STATS}/icons/objectif.png`,
  "Calories aujourd'hui": `${BASE_STATS}/icons/calories.png`,
  'Séances récentes':     `${BASE_STATS}/icons/seances.png`,
  'Programme du jour':    `${BASE_STATS}/icons/programme.png`,
  'session-icon':         `${BASE_STATS}/icons/session.png`,
}/stats/objectif.jpg`,
