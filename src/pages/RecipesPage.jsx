...
type="button"
onClick={() => {
window.location.href = `/nutrition/recette/${recipe.id}`
}}
style={{
...
<MacroBadge>P {Number(recipe.proteins || 0).toFixed(0)}g</MacroBadge>
<MacroBadge>C {Number(recipe.carbs || 0).toFixed(0)}g</MacroBadge>
<MacroBadge>F {Number(recipe.fats || 0).toFixed(0)}g</MacroBadge>
</div>
