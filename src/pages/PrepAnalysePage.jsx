                ...
                <div>
                  ...
                  <svg viewBox="0 0 200 460" style={{ width: '100%', height: 280, display: 'block' }}>
                    ...
                    {DOMS_ZONES.map(zone => {
                      const POSITIONS = {
                        nuque:      [{x:100, y:34}],
                        epaules:    [{x:52,  y:78}, {x:148, y:78}],
                        coudes:     [{x:36,  y:158},{x:164, y:158}],
                        poignets:   [{x:30,  y:214},{x:170, y:214}],
                        tronc:      [{x:100, y:126}],
                        lombaires:  [{x:100, y:188}],
                        hanches:    [{x:72,  y:232},{x:128, y:232}],
                        cuisses:    [{x:76,  y:292},{x:124, y:292}],
                        genoux:     [{x:78,  y:348},{x:122, y:348}],
                        chevilles:  [{x:80,  y:405},{x:120, y:405}],
                        pieds:      [{x:74,  y:438},{x:126, y:438}],
                      }
